...
public class IterativeMaze {
    ...
    private int delay = 1;
    private int speed = 50; // must be >= 1, limits painted frames to increase drawing speed
    private int scale = 1;
    private int jumpDist = 1; // must be >= 1, controls the distance between maze halls
    private int size = 501; // must be >= 2, controls the height & width of the maze

    private double lastDirectionWeighting = 1; // must be at least 1
    private double randomnessWeighting = 10;
    private Direction directionalWeighting = Direction.Up;
    private double directionWeightingAmount = 10; // must be at least 1
    ...
    public void setLastDirectionWeighting(int lastDirectionWeighting) {
        this.lastDirectionWeighting = lastDirectionWeighting;
    }

    public double getRandomnessWeighting() {
        return randomnessWeighting;
    }

    public void setRandomnessWeighting(int randomnessWeighting) {
        this.randomnessWeighting = randomnessWeighting;
    }

    public Direction getDirectionalWeighting() {
        return directionalWeighting;
    }

    public void setDirectionalWeighting(Direction directionalWeighting) {
        this.directionalWeighting = directionalWeighting;
    }

    public double getDirectionWeightingAmount() {
        return directionWeightingAmount;
    }

    public void setDirectionWeightingAmount(int directionWeightingAmount) {
        this.directionWeightingAmount = directionWeightingAmount;
    }
